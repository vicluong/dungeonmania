...
public class BattleFacade {
    ...
    public BattleFacade(JSONArray battles) {
        if (battles != null) {
            battles
            .forEach(b -> battleResponses.add(new BattleResponse((JSONObject) b)));
        }
    }
    ...
    public JSONArray toJSON() {
        ...
        battleResponses.stream().forEach(br -> battles.put(br.toJSON()));
        return battles;
    }
}
